        ...
        <box flexGrow={1} gap={1}>
          <box flexDirection="row" justifyContent="space-between">
            <text fg={props.context.theme.text.base}>
              <b>{t("feature.sidebar.onboarding.title")}</b>
            </text>
            <text
          ...
          <text fg={props.context.theme.text.muted}>{t("feature.sidebar.onboarding.freeModels")}</text>
          <text fg={props.context.theme.text.muted}>{t("feature.sidebar.onboarding.providers")}</text>
          <box
          ...
          >
            <text fg={props.context.theme.text.base}>{t("feature.sidebar.onboarding.connect")}</text>
